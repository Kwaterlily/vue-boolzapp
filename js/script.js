var app = new Vue(
  {
      ...
      methods: {
          settaggioIndexContatti: function(position) {
              this.nowContact = position;
          ...
          newMessage: function(contact) {
              ...
              this.filtroContatti[contact].messages.push(sendNewMessage);
              ...
              setTimeout(
                  ()=> {
                      ...
                      this.filtroContatti[contact].messages.push(newReceivedMessage);
                  },3000
              );
          },
      },
      // soluzione non compresa appieno
      computed: {
          filtroContatti() {
